    ...
    return <>
        ...
        <div className="outerContainer">
            ...
            <div className="homeBar">
                <span className="homeBarText">&nbsp;* {getName()}</span>
            ...
            </div>
                {
                    ...
                    ? <>
                        ...
                        <a className="bottomText" href="https://blaze-comic-viewer.netlify.app" target="_blank" rel="noreferrer">Demo User:Freeze, Pass:123</a>
                    </>
            ...
            <div className="homeContainer" id="linksContainer">
                <div className="homeBar">
                    <span className="homeBarText">&nbsp;*    Local Disc (C:/{tab === 'none' ? '' : tab})</span>
                ...
                <div className="linkBox" id="viewerBox" style={tab === 'viewer' ? {background: 'rgb(7,255,234)'} : {}} onClick={() => slide('viewer')}>
                    <img className="linkBoxIcon" src={viewer} alt="viewer" />
                    <span className="linkBoxText"> Blaze Comic Viewer</span>
                </div>
                <div className="linkBox" id="7red3box" style={tab === '7red3' ? {background: 'rgb(7,255,234)'} : {}} onClick={() => slide('7red3')}>
                    <img className="linkBoxIcon" src={seventhree} alt="seventhree" />
                    <span className="linkBoxText"> 7Red3</span>
                </div>
                <div className="linkBox" id="carrotBox" style={tab === 'carrot' ? {background: 'rgb(7,255,234)'} : {}} onClick={() => slide('carrot')}>
                    <img className="linkBoxIcon" src={carrot} alt="carrot" />
                    <span className="linkBoxText"> CarrotWolf</span>
                </div>
                <div className="linkBox" id="githubBox" style={tab === 'github' ? {background: 'rgb(7,255,234)'} : {}} onClick={() => slide('github')}>
                    <img className="linkBoxIcon" src={github} alt="github" />
                    <span className="linkBoxText"> GitHub</span>
                </div>
                <div className="linkBox" id="creditsBox" style={tab === 'credits' ? {background: 'rgb(7,255,234)'} : {}} onClick={() => slide('credits')}>
                    <img className="linkBoxIcon" src={credits} alt="credits" />
                    <span className="linkBoxText"> Credits</span>
                </div>
                <a href="http://blazewiseman.com/files/resume.pdf" target="_blank" rel="noreferrer" style={{color: 'black'}}>
                    <div className="linkBox" id="resumeBox" style={tab === 'resume' ? {background: 'rgb(7,255,234)'} : {}}>
                        <img className="linkBoxIcon" src={downarrow} alt="downarrow" />
                        <span className="linkBoxText"> Resume</span>
                    </div>
                </a>
            </div>
        </div>
